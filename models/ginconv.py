...
class GINConvNet(torch.nn.Module):
    def __init__(self, n_output=1,num_features_xd=78, num_features_xt=25,
        ...
        # self.fc1_xt = nn.Linear(2944, output_dim) # for original data
        self.fc1_xt = nn.Linear(3968, output_dim) # ccle candle
...
class GINConvNetPretrain(torch.nn.Module):
    def __init__(self, n_out_regr=3, n_out_clsf=1, num_features_xd=78, num_features_xt=25,
        ...
        self.out_regr = nn.Linear(128, n_out_regr)
        self.out_clsf = nn.Linear(128, n_out_clsf)
    ...
    def forward(self, data):
        ...
        xc = self.relu(xc)
        xc = self.dropout(xc)
        out_regr = self.out_regr(xc)
        out_clsf = self.out_clsf(xc)
        # out = nn.Sigmoid()(out)
        # return out, x
        return out_regr, out_clsf
